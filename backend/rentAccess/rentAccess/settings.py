...
LOGGING = {
	...
	'handlers': {
		...
		'server_logs_info': {
			...
			'interval': 1,
			'formatter': 'file',
			'filename': env.str('SERVER_INFO_LOG_PATH'),
		...
		'request_logs_info': {
			...
			'filename': env.str('REQUEST_INFO_LOG_PATH'),
		...
		'template_logs_info': {
			...
			'interval': 1,
			'formatter': 'file',
			'filename': env.str('TEMPLATE_INFO_LOG_PATH'),
		...
		'security_logs_info': {
			...
			'interval': 1,
			'formatter': 'file',
			'filename': env.str('SECURITY_INFO_LOG_PATH'),
		...
		'properties_images': {
			...
			'interval': 1,
			'formatter': 'file',
			'filename': env.str('PROPERTIES_IMAGES_INFO_LOG_PATH'),
		...
		'properties_crud_info_file': {
			...
			'interval': 1,
			'formatter': 'file',
			'filename': env.str('PROPERTIES_CRUD_INFO_LOG_PATH')
		},
		'properties_owners_info_file': {
			...
			'interval': 1,
			'formatter': 'file',
			'filename': env.str('PROPERTIES_OWNERS_INFO_LOG_PATH')
		},
		'properties_locks_info_file': {
			...
			'interval': 1,
			'formatter': 'file',
			'filename': env.str('PROPERTIES_LOCKS_INFO_LOG_PATH')
		},
		'properties_bookings_info_file': {
			...
			'interval': 1,
			'formatter': 'file',
			'filename': env.str('PROPERTIES_BOOKING_INFO_LOG_PATH')
		}
